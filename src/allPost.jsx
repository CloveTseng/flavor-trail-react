function AllPost() {
    return (
        <div className="allPost container">
            ...
            <div className="postNav container mb-13 mb-lg-7">
                    ...
                    <div className="col-12 col-lg-auto px-0">
                        ...
                        <div className="d-none d-lg-block">
                            <div className="d-flex align-items-stretch bg-light rounded-3">
                                <button
                                    type="button"
                                    className="filter-btn btn fw-normal text-gray-700 btn-gray-200 py-2 px-3"
                                    style={{ width: 114, height: 40, borderRadius: "8px 0 0 8px" }}
                                >
                                    全部貼文
                                </button>
                                <button
                                    type="button"
                                    className="btn fw-normal btn-primary text-white px-3 d-flex align-items-center"
                                    style={{ width: 114, height: 40, borderRadius: 8 }}
                                >
                                    <img
                                        src="../assets/images/icon/flame.svg"
                                        alt=""
                                        className="me-2"
                                        width={16}
                                        height={16}
                                ...
                                <button
                                    type="button"
                                    className="btn fw-normal text-gray-700 btn-gray-200 py-2 px-3 d-flex align-items-center"
                                    style={{ width: 114, height: 40, borderRadius: 0 }}
                                >
                                    <img
                                        src="../assets/images/icon/drumstick.svg"
                                        alt=""
                                        className="me-2"
                                        width={16}
                                        height={16}
                                ...
                                <button
                                    type="button"
                                    className="btn fw-normal text-gray-700 btn-gray-200 py-2 px-3 d-flex align-items-center"
                                    style={{ width: 114, height: 40, borderRadius: "0 8px 8px 0" }}
                                >
                                    <img
                    ...
                    <div className="col-auto d-flex justify-content-lg-between flex-grow-1 px-0">
                        ...
                        <div className="d-flex flex-grow-1">
                            <div className="me-2 mx-lg-2">
                                <button
                                    type="button"
                                    className="btn btn-gray-200 fw-normal d-flex align-items-center justify-content-between px-3 rounded-3 fs-6"
                            ...
                            <div className="d-lg-none d-flex align-items-center">
                                ...
                                <button
                                    className="d-flex btn btn-gray-200 justify-content-center text-center align-items-center p-3 mx-3 rounded-3"
                                    style={{ height: 40 }}
                                >
                                    <img
                                        src="../assets/images/icon/undo-2.png"
                                        alt=""
                                        width="16px"
                                        height="16px"
                                    />
                        ...
                        <div className="d-flex align-items-center">
                            ...
                            <button
                                className="d-none d-lg-flex btn btn-gray-200 justify-content-center align-items-center p-3 px-7 ms-2 rounded-3"
                                style={{ height: 40 }}
                            >
                                清空篩選
                                <img
            ...
            <main className="postCard mb-18">
                {/* 第一張卡片 */}
                <article className="post-card bg-white p-5 my-5 rounded-3">
                    <div className="row flex-column-reverse flex-lg-row">
                            ...
                            <header className="ps-lg-5">
                                <div className="d-flex flex-wrap align-items-center py-4">
                                    <div className="card-header d-flex align-items-center me-auto mb-5 mb-md-0">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="../assets/images/allPost/Ellipse 2.svg"
                                                alt="User avatar"
                                            ...
                                            />
                                            <div>
                                                <h2 className="h5 mb-1">法國地頭蛇</h2>
                                                <p className="text-gray-700 small mb-0">
                                                    台北市 / 信義區· 2hr
                                                </p>
                                            </div>
                                        </div>
                                        <a href="#" className="ms-auto d-md-none">
                                            <svg
                                                width={24}
                                                height={24}
                                                viewBox="0 0 24 24"
                                ...
                                <div className="py-7 border-top border-bottom">
                                    <div className="d-flex">
                                        <h2 className="fs-3 mb-5">奢華午餐，尋找飢餓的你！</h2>
                                        <a
                                            href="
                                #"
                                    ...
                                    <p className="text-gray-700 text-truncate mb-5">
                                        公司今天的會議取消了，現在有20個未開封的精緻便當在半公里孤單寂寞。
                                    </p>
                                ...
                                <div className="post-card-md-btn-list d-none d-md-block mt-5">
                                    <div className="row mx-0">
                                        ...
                                        <div className="col px-1">
                                            <button className="btn w-100 d-flex justify-content-center align-items-center">
                        ...
                        <div className="post-card-img col-lg-3 px-4 mb-7 mb-lg-0">
                            ...
                            >
                                ...
                                <img
                                    src="../assets/images/allPost/Rectangle 2.svg"
                                    alt="Property image"
                            ...
                            <header className="ps-lg-5">
                                <div className="d-flex flex-wrap align-items-center py-4">
                                    <div className="card-header d-flex align-items-center me-auto mb-5 mb-md-0">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="../assets/images/allPost/Ellipse 2.png"
                                                alt="User avatar"
                                            ...
                                            />
                                            <div>
                                                <h2 className="h5 mb-1">伯朗大道</h2>
                                                <p className="text-gray-700 small mb-0">
                                                    台北市 / 信義區· 2hr
                                                </p>
                                            </div>
                                        </div>
                                        {/* <a href="#" class="ms-auto d-md-none">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <div className="d-flex flex-wrap gap-2">
                                        <span className="badge bg-primary">熱門</span>
                                        <span className="badge bg-primary">預留中</span>
                                        <span className="badge bg-primary">已領取</span>
                                    </div>
                                </div>
                                <div className="py-7 border-top border-bottom">
                                    <div className="d-flex">
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <p className="text-gray-700 text-truncate mb-5">
                                        我已經喝了一杯，再來一杯恐怕是要整晚失眠。有沒有在附近正好需要提神的朋友。
                                    </p>
                                    <div className="d-flex gap-7 text-black">
                                        <div className="d-flex align-items-center">
                                            <svg
                        ...
                        <div className="post-card-img col-lg-3 px-4 mb-7 mb-lg-0">
                            <a href="#" className="img-hover position-relative w-100 h-100">
                                <div className="card-hover bg-primary w-100 h-100 position-absolute top-0 start-0 rounded-3">
                                    <svg
                                        width={40}
                                        height={40}
                                ...
                                <img
                                    src="../assets/images/allPost/Rectangle 2.png"
                                    alt="Property image"
                                    className="img-fluid rounded-3 object-fit-cover"
                                />
                            </a>
                            ...
                            <header className="ps-lg-5">
                                <div className="d-flex flex-wrap align-items-center py-4">
                                    <div className="card-header d-flex align-items-center me-auto mb-5 mb-md-0">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="../assets/images/allPost/Ellipse 3.png"
                                                alt="User avatar"
                                                className="rounded-circle me-3"
                                                width={48}
                                                height={48}
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    d="M12 3.00023H5C4.46957 3.00023 3.96086 3.21094 3.58579 3.58601C3.21071 3.96109 3 4.46979 3 5.00023V19.0002C3 19.5307 3.21071 20.0394 3.58579 20.4144C3.96086 20.7895 4.46957 21.0002 5 21.0002H19C19.5304 21.0002 20.0391 20.7895 20.4142 20.4144C20.7893 20.0394 21 19.5307 21 19.0002V12.0002M18.375 2.62523C18.7728 2.2274 19.3124 2.00391 19.875 2.00391C20.4376 2.00391 20.9772 2.2274 21.375 2.62523C21.7728 3.02305 21.9963 3.56262 21.9963 4.12523C21.9963 4.68784 21.7728 5.2274 21.375 5.62523L12.362 14.6392C12.1245 14.8765 11.8312 15.0501 11.509 15.1442L8.636 15.9842C8.54995 16.0093 8.45874 16.0108 8.37191 15.9886C8.28508 15.9663 8.20583 15.9212 8.14245 15.8578C8.07907 15.7944 8.03389 15.7151 8.01164 15.6283C7.9894 15.5415 7.9909 15.4503 8.016 15.3642L8.856 12.4912C8.95053 12.1693 9.12453 11.8763 9.362 11.6392L18.375 2.62523Z"
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <div className="py-7 border-top border-bottom">
                                    <div className="d-flex">
                                        <h2 className="fs-3 mb-5">好吃到不行的披薩在這裡等你來領</h2>
                                        {/* <a href="
                                #" class="ms-auto d-none d-md-block">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        ...
                        <div className="post-card-img col-lg-3 px-4 mb-7 mb-lg-0">
                            <a href="#" className="img-hover position-relative w-100 h-100">
                                ...
                                <img
                                    src="../assets/images/allPost/Rectangle 3.png"
                                    alt="Property image"
                                    className="img-fluid rounded-3 object-fit-cover"
                                />
                            </a>
                            ...
                            <header className="ps-lg-5">
                                <div className="d-flex flex-wrap align-items-center py-4">
                                    <div className="card-header d-flex align-items-center me-auto mb-5 mb-md-0">
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="../assets/images/allPost/Ellipse 4.png"
                                                alt="User avatar"
                                                className="rounded-circle me-3"
                                                width={48}
                                                height={48}
                  ...
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <div className="py-7 border-top border-bottom">
                                    <div className="d-flex">
                                        <h2 className="fs-3 mb-5">氣氣7777777便當沒發完不能下班</h2>
                                        {/* <a href="
                                #" class="ms-auto d-none d-md-block">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      ...
                      stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <p className="text-gray-700 text-truncate mb-5">
                                        我要發完便當才能下班＠＠快來當好心人幫忙吃便當。地點在台中科技大學的資訊...
                                    </p>
                                    <div className="d-flex gap-7 text-black">
                                        <div className="d-flex align-items-center">
                                            <svg
                        ...
                        <div className="post-card-img col-lg-3 px-4 mb-7 mb-lg-0">
                            <a href="#" className="img-hover position-relative w-100 h-100">
                                ...
                                <img
                                    src="../assets/images/allPost/post-4.jpg"
                                    alt="Property image"
                                    className="img-fluid rounded-3 object-fit-cover"
                                />
                            </a>
