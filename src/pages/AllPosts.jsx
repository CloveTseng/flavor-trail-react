          ...
          <h1 className='d-flex align-items-center fs-1 fw-bolder'>
            ...
            >
              {filterOptions.map(({ name, icon }) => (
                ...
                >
                  <span style={{ width: 16, height: 16 }} className='me-2'>{icon}</span>
                  {name}
                </button>
              ))}
            </ul>
                  ...
                  <div className='row mx-0'>
                    ...
                    <div className='col ps-1 pe-0'>
                      <button
                        ...
                        className='nomoral-btn btn w-100 d-flex justify-content-center align-items-center'
                      >
                        <span className={`me-2 ${fllows[1] ? 'text-primary' : ''}`}>追蹤貼文</span>
                        <svg
                          width={16}
                          height={16}
                          viewBox='0 0 24 24'
                          fill={fllows[1] ? '#00503F' : 'none'}
                          xmlns='http://www.w3.org/2000/svg'
                        >
                          <path
