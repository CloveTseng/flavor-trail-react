...
function AllPosts() {
  ...
  const [fllows, setFllows] = useState({});
          ...
          <h1 className='d-flex align-items-center fs-1 fw-bolder'>
            ...
            >
              ...
              {/* <li className='d-flex'>
                <a
                  href='#'
                  className='active dropdown-item d-flex align-items-center gap-2'
                >
                  <svg
                    width={16}
                    height={16}
              ...
              <div className='d-flex align-items-stretch bg-light rounded-3'>
                ...
                {/* {filterOptions.map(({ name, icon }) => (
                  <button
                    ...
                    onClick={() => handlePostFilter(name)}
                    type='button'
                    className={`btn fw-normal text-gray-700 btn-gray-200 py-2 px-3 d-flex justify-content-center align-items-center ${
                      activeFilter === name ? 'active' : ''
                    }`}
                    style={{
                      width: name === "全部貼文" ? 112 : 128,
                      height: 40,
                    }}
                  >
                    <span className={`${name === "全部貼文" ? "" : "me-2"}`}>{icon}</span>
                    {name}
                    </button>
                ))} */}
              </div>
              ...
              <div className='dropdown position-relative'>
                ...
                <ul className='dropdown-menu custom-dropdown-menu position-absolute'>
                  {food.map((food, index) => (
                    <li key={index}>
                      <a
                        onClick={(e) => handleChangeFood(e, food)}
                        className='dropdown-item'
                        href='#'
                      >
                        {food}
                  ...
                  <div className='row mx-0'>
                    ...
                    <div className='col px-1'>
                      <button
                        ...
                        type='button'
                        className='nomoral-btn nomoral-btn btn w-100 d-flex justify-content-center align-items-center'
                      >
                        <span
                          className={`me-2 ${likes[1] ? 'text-primary' : ''}`}
                        >
                          點讚
                        </span>
                        <svg
                          ...
                          height={16}
                          viewBox='0 0 24 24'
                          fill={likes[1] ? '#00503F' : 'none'}
                          xmlns='http://www.w3.org/2000/svg'
                        >
                          <path
                            d='M7 10V22M15 5.88L14 10H19.83C20.1405 10 20.4467 10.0723 20.7244 10.2111C21.0021 10.35 21.2437 10.5516 21.43 10.8C21.6163 11.0484 21.7422 11.3367 21.7977 11.6422C21.8533 11.9477 21.8369 12.2619 21.75 12.56L19.42 20.56C19.2988 20.9754 19.0462 21.3404 18.7 21.6C18.3538 21.8596 17.9327 22 17.5 22H4C3.46957 22 2.96086 21.7893 2.58579 21.4142C2.21071 21.0391 2 20.5304 2 20V12C2 11.4696 2.21071 10.9609 2.58579 10.5858C2.96086 10.2107 3.46957 10 4 10H6.76C7.13208 9.9998 7.49674 9.89581 7.81296 9.69972C8.12917 9.50363 8.38442 9.22321 8.55 8.89L12 2C12.4716 2.00584 12.9357 2.11817 13.3578 2.3286C13.7799 2.53902 14.1489 2.84211 14.4374 3.2152C14.7259 3.5883 14.9263 4.02176 15.0237 4.4832C15.1212 4.94464 15.113 5.42213 15 5.88Z'
                            stroke={likes[1] ? '#00503F' : '#121212'}
                            strokeWidth={2}
                            strokeLinecap='round'
                            strokeLinejoin='round'
                          />
                    ...
                    <div className='col ps-1 pe-0'>
                      <button
                        onClick={()=>{handelChangeFllow(1)}}
                        type='button'
                        className='nomoral-btn nomoral-btn btn w-100 d-flex justify-content-center align-items-center'
                      >
                        <span className={`me-2 ${fllows[1] ? 'text-deco-green' : ''}`}>追蹤貼文</span>
                        <svg
                          width={16}
                          height={16}
                          viewBox='0 0 24 24'
                          fill={fllows[1] ? '#576E22' : 'none'}
                          xmlns='http://www.w3.org/2000/svg'
                        >
                          <path
                  ...
                  <div className='mb-5'>
                    <div className='d-flex align-items-center'>
                      <div className='ps-0 pe-1'>
                        <button onClick={() => {
                          handleChangeLike(1);
                        }} type='button' className='nomoral-sm-btn btn p-5'>
                          <svg
                            className='d-block'
                            width={16}
                            height={16}
                      ...
                      <div className='px-1'>
                        <button type='button' className='nomoral-sm-btn btn p-5'>
                          <svg
                            className='d-block'
                            width={16}
                            height={16}
                      ...
                      <div className='ps-1 pe-0'>
                        <button onClick={()=>{handelChangeFllow(1)}} type='button' className='nomoral-sm-btn btn p-5'>
                          <svg
                            className='d-block'
                            width={16}
                            height={16}
                ...
                <div className='post-card-md-btn-list d-none d-md-block mt-5'>
                  <div className='row mx-0'>
                    ...
                    <div className='col px-1'>
                      ...
                      >
                        <span
                          className={`me-2 ${likes[2] ? 'text-primary' : ''}`}
                        >
                          點讚
                        </span>
                        <svg
