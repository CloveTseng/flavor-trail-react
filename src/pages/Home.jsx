            ...
            <div className="swiper-wrapper">
                ...
                >
                  ...
                  <div className="foodCard-text p-7 border border-top-0 border-2 border-deco-pink">
                    <p className="multiline-ellipsis">
                      嗨大家!今天有一大盤剛出爐的義大利麵,完全不用擔心,大家都可以來拿!🍝
                      食物超新鮮、好粗!我會在下午 2 點到 4
                      點之間待在家裡,歡迎來取!別忘了帶上你們的好心情~ 😄🌟
                    </p>
                  </div>
                </a>
              </div>
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="foodCard-text p-7 border border-top-0 border-2 border-deco-pink">
                    <p className="multiline-ellipsis">
                      甜點時間!今天我有一大盤自己做的巧克力布朗尼,超級濃郁、超級好吃!🥳
                      有興趣的朋友明天上午 10 點到中午 12
                      點來取。希望這些甜點能為你的一天帶來些許甜蜜和快樂!💖
                    </p>
                  </div>
                </a>
              </div>
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="foodCard-text p-7 border border-top-0 border-2 border-deco-pink">
                    <p className="multiline-ellipsis">
                      早安,朋友們!家裡剩了一些自製的早餐三明治和現泡的紅茶,三明治裡面有火腿、雞蛋和起司,非常豐富!🍳🧀
                      這些美味的營養三明治會在今天中午11
                      點前等你來拿！不要錯過囉！
                    </p>
                  </div>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="foodCard-text p-7 border border-top-0 border-2 border-deco-pink">
                    <p className="multiline-ellipsis">
                      🚀
                      嘿!家裡剩下了一大鍋自製的咖哩,馬鈴薯、紅蘿蔔、雞腿肉味道超棒,還有很多米飯~🍛
                      只要你喜歡咖哩,這些美味就屬於你!我會在今天晚上 7 點到 9
                      點在家,來領取吧！期待你們的到來！
                    </p>
                  </div>
                </a>
              ...
              <div className="swiper-slide">
                ...
                >
                  ...
                  <div className="foodCard-text p-7 border border-top-0 border-2 border-deco-pink">
                    <p className="multiline-ellipsis">
                      嗨大家！今天有幾份剛出爐的漢堡，歡迎大家都可以來拿！🍔
                      食物非常新鮮、美味可口！我會在中午 12 點到下午 2
                      點之間待在家裡，歡迎大家來取！別忘了帶上你們的環保袋哦~
                      😄🌟
                    </p>
                  </div>
                </a>
      ...
      <section className="bg-deco-coral py-lg-18 py-12">
        <div className="container">
          <div className="row mb-lg-17 d-flex flex-column flex-lg-row mb-12 mb-lg-17">
            <div className="col-lg-4 col-12 mb-7 mb-lg-0">
              <a
                href="#"
                className="foodtalk-cover bg-primary position-relative"
              >
                <div className="foodtalk-back w-100 h-100 position-absolute top-0 left-0">
                  <img
                ...
                <div>
                  ...
                  <div className="p-7 h-100">
                    <p className="text-deco-coral fw-medium fs-5 mb-7">
                      超級喜歡這個平台!在這裡我不僅能找到新鮮的食物,還能遇到很多友好的分享者。每次與其他
                      Buddy
                      的互動都充滿了正能量,這讓我覺得自己真的成為了這個社群的一部分，謝謝你們！
                    </p>
            ...
            <div className="col-lg-4 col-12 mb-7 mb-lg-0">
              <a
                ...
                className="foodtalk-cover bg-primary position-relative"
              >
                <div className="foodtalk-back w-100 h-100 position-absolute top-0 left-0 m-auto">
                  <img
                    src="../assets/images/deco/talk-pink.svg"
                    alt="talk-pink"
                  />
                ...
                <div>
                  ...
                  <div className="p-7">
                    <p className="text-deco-coral fw-medium fs-5 mb-7">
                      謝謝 Flavor Trail
                      的大家，今天收到一位超棒的分享者提供的美味午餐！真的很感謝你們的慷慨,讓我在窘困時期不再擔心吃飯問題。這種分享讓我感到社群的溫暖，謝謝你們！
                    </p>
                    <h3 className="text-deco-coral fw-bold lh-xs fs-md-4">
                      — 努力生存的勇者 —
                    </h3>
            ...
            <div className="col-lg-4 col-12 mb-7 mb-lg-0 h-100">
              <a
                href="#"
                className="foodtalk-cover bg-primary position-relative"
              >
                ...
                <div>
                  ...
                  <div className="p-7">
                    <p className="text-deco-coral fw-medium fs-5 mb-7">
                      成為 Flavor buddy
                      真的是一件非常有趣的事!我每次分享食物的時候都會特別注意衛生,因為知道它們可能會送到需要的人手中。這不僅是對食物的尊重,也是對這個社群的愛。
                    </p>
                    <h3 className="text-deco-coral fw-bold lh-xs fs-md-4">
                      — 巷口阿美 —
                    </h3>
