      ...
      <section className="container notifyList">
        <ul className="row">
          ...
          <li className="col-12 px-0">
            ...
            >
              ...
              <div className="col-12 col-lg-9 order-lg-2 ps-lg-6 px-0">
                ...
                <p className="fs-6 text-gray-700 mb-0">
                  法國地頭蛇
                  ,我們非常重視你的意見,請花一點時間對你領取的食物進行評價。你的反饋將幫助我們改進並提供更好的服務。
                </p>
              </div>
            </a>
          </li>
          <li className="col-12 px-0">
            <a
              href="#"
              className="notify-cover row align-items-center position-relative stretched-link p-7 unchecked border-bottom-lg border-lg-gray-400 mx-4"
            >
              <div className="notify-back w-100 h-100 position-absolute">
                <svg
                  width="40"
          ...
          <li className="col-12 d-none d-lg-block">
            <a
              href="#"
              className="notify-cover row align-items-center position-relative stretched-link p-7 bg-white mx-4"
            >
              <div className="notify-back w-100 h-100 position-absolute">
                <svg
                  width="40"
          ...
          <li className="col-12 d-none d-lg-block">
            <a
              href="#"
              className="notify-cover row align-items-center position-relative stretched-link p-7 unchecked mx-4"
            >
              <div className="notify-back w-100 h-100 position-absolute">
                <svg
                  width="40"
          ...
          <li className="col-12 px-0 mb-19">
            <div className="text-center bg-white mx-4 py-11 round-bottom">
              <div
                className="spinner-border text-gray-700 border-2"
                role="status"
